          ...
          <div class="col-md-12">
            <div class="card card-primary card-outline">
              ...
              <div class="card-footer bg-gray-light">
                @foreach($post->comments->take(3)->sortByDesc('date') as $comment)
                  <div class="mailbox-read-info">
              ...
              <div class="card-footer">
                ...
                <div class="float-right">
                  <a href="{{ route("admin_posts_view",["post_id"=>$post->id]) }}" class="btn btn-default"><i class="fas fa-eye"></i> Ver completo</a>
                </div>
              </div>
              <!-- /.card-footer -->
            </div>
